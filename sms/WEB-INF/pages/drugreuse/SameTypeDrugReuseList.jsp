...
<head>
    ...
    <script type="text/javascript" src="${ctx}/sms/statics/pages/js/drugreuse/sametypedrugreuselist.js"></script>
            ...
            <form id="searchForm" action="#">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                	 ...
                	 <tr>
                    	<th class="r" width="13%">患者姓名：</th>
                        <td width="18%">
                            <input  class="inputW160"/>
                        </td>                         
                        <th width="13%" class="r">患者身份证号：</th>
                        <td width="15%" colspan='2'>
                            <input  class="inputW160"/>
                        </td> 
                        <th width="13%" class="r">医生姓名</th>
                        <td width="18%">
                        <input  class="inputW160" />
                        </td> 
                     </tr>
