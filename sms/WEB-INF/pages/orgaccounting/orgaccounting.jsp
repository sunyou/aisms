...
<head>
    ...
    <script type="text/javascript" src="${ctx}/sms/statics/pages/js/orgaccounting/orgaccounting.js"></script>
...
<div class="wrap100 quickrecharge"> 
	...
	<!--查询条件 begin-->
        ...
        <!--查询条件 end-->
			<div>
            	<table id="orgaccountlist" width="100%" border="0" cellspacing="0" cellpadding="0">
               
            	</table>
            	<div id="orgaccountlist_pager"></div>
        	</div>
        </div>
</div> 
