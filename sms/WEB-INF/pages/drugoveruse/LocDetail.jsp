                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="13%" colspan="2">
                            <label><input name="date1" type="radio" value="1" />日 </label> 
							<label><input name="date1" type="radio" value="2" />月 </label> 
							<label><input name="date1" type="radio" value="3" />年 </label> 
                            <select id="year" name="year" style="width:50px;display:none;"  multiply="true" >                               
                               <option>2015</option>
                               <option>2014</option>
                               <option>2013</option>
                               <option>2012</option>
                            ...
                            <select id="month" name="locId" style="width:50px;display:none;"  multiply="true" >                               
 							   <option>1</option>
                               <option>2</option>
                               <option>3</option>
                               <option>4</option>
