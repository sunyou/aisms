...
<head>
    ...
    <script type="text/javascript" src="${ctx}/sms/statics/pages/js/drugoverusewarn/drugoverusewarnlist.js"></script>
...
<div class="wrap100 quickrecharge">
	<div class="tabbable" style=" margin-top:10px">
       <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
           ...
           <li class="">
               <a data-toggle="tab" href="#locDiv" aria-expanded="false">科室</a>
           </li> 
           
           <li class="">
               <a data-toggle="tab" href="#docDiv" aria-expanded="false">医生</a>
           </li> 
           
           <li class="">
               <a data-toggle="tab" href="#patientDiv" aria-expanded="false">个人</a>
           </li> 
       </ul>
	 ...
	 <div class="q_r_list tab-pane " id="locDiv" >	
		<!--查询条件 begin-->
	        <div class="listTable">
	            <input type="hidden" id="currentLocId" value="${cookie_locId }"/>
	            <input type="hidden" id="AUDIT_REPORT_BUTTON" value="${AUDIT_REPORT_BUTTON }"/>
	            ...
	            <form id="searchForm2" action="#">
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                        <th class="r" width="6%">时间 ：</th>
	                        <td width="13%" colspan="2">
	                              <label><input name="date2" type="radio" value="day" checked="checked"/>日 </label> 
							<label><input name="date2" type="radio" value="month" />月 </label> 
							<label><input name="date2" type="radio" value="year" />年 </label> 
                            <input id="dateTime2" name="dateTime2" class="inputW120" onfocus="formatDate2()"/>
	                        </td>                        
	                        <th width="6%" class="r">行政区划：</th>
	                        <td width="13%">
	                            <select id="area" name="area" style="width:160px;"  multiply="true" >                               
	        ...
	        <!--查询条件 end-->
				<div>
	            	<table id="anlistLoc" width="100%" border="0" cellspacing="0" cellpadding="0">
	               
	            	</table>
	            	<div id="anlistLoc_pager"></div>
	        	</div>
	     </div>
	 <div class="q_r_list tab-pane " id="docDiv" >	
		<!--查询条件 begin-->
	        <div class="listTable">
	            <input type="hidden" id="currentLocId" value="${cookie_locId }"/>
	            <input type="hidden" id="AUDIT_REPORT_BUTTON" value="${AUDIT_REPORT_BUTTON }"/>
	            ...
	            <form id="searchForm3" action="#">
	                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                        <th class="r" width="6%">时间 ：</th>
	                        <td width="13%" colspan="2">
	                        <label><input name="date3" type="radio" value="day" checked="checked"/>日 </label> 
							<label><input name="date3" type="radio" value="month" />月 </label> 
							<label><input name="date3" type="radio" value="year" />年 </label> 
                            <input id="dateTime3" name="dateTime3" class="inputW120" onfocus="formatDate3()"/>
	                        </td>                        
	                        <th width="6%" class="r">行政区划：</th>
	                        <td width="13%">
	                            <select id="area" name="area" style="width:160px;"  multiply="true" >                               
	        ...
	        <!--查询条件 end-->
				<div>
	            	<table id="anlistDoc" width="100%" border="0" cellspacing="0" cellpadding="0">
	               
	            	</table>
	            	<div id="anlistDoc_pager"></div>
	        	</div>
	     </div>
	 
		<div class="q_r_list tab-pane" id="patientDiv">	
		<!--查询条件 begin-->
	        <div class="listTable">
	            <input type="hidden" id="currentLocId" value="${cookie_locId }"/>
	            <input type="hidden" id="AUDIT_REPORT_BUTTON" value="${AUDIT_REPORT_BUTTON }"/>
	            <input type="hidden" id="pacsViewPath" value="${pacsViewPath }"/>
	            <form id="searchForm4" action="#">
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                        <th class="r" width="6%">时间 ：</th>
	                        <td width="13%" colspan="2">
	                           <label><input name="date4" type="radio" value="day" checked="checked"/>日 </label> 
							<label><input name="date4" type="radio" value="month" />月 </label> 
							<label><input name="date4" type="radio" value="year" />年 </label> 
                            <input id="dateTime4" name="dateTime4" class="inputW120" onfocus="formatDate4()"/>
	                        </td>                        
	                        <th width="6%" class="r">行政区划：</th>
	                        <td width="13%">
	                            <select id="area" name="area" style="width:160px;"  multiply="true" >                               
	        ...
	        <!--查询条件 end-->
				<div>
	            	<table id="anlistPatient" width="100%" border="0" cellspacing="0" cellpadding="0">
	               
	            	</table>
	            	<div id="anlistPatient_pager"></div>
	        	</div>
       </div>	
