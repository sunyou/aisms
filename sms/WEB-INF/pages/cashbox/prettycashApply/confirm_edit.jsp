...
<head>
    ...
    <script type="text/javascript" src="${ctx}/sms/statics/pages/js/cashbox/prettycashApply/confirm_edit.js"></script>
</head>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <form class="form-horizontal" role="form" id="editForm">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right"> 领取人：</label>

                        <div class="col-xs-4">
                            <strong><label id="applycashboxusername" class="formlabel"></label></strong>
                        </div>

                        <label class="col-sm-2 control-label no-padding-right"> 钱箱号： </label>

                        <div class="col-xs-4">
                            <strong><label id="applycashboxno" class="formlabel"></label></strong>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right"> 领取金额(元)： </label>

                        <div class="col-xs-4">
                            <label id="applyamount" class="formlabel"></label>
                        </div>
                        <label class="col-sm-2 control-label no-padding-right"> 主管柜员： </label>

                        <div class="col-xs-4">
                            <label id="backupcashboxusername" class="formlabel"></label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <textarea cols="60" rows="3" name="comments" id="comments" readonly="readonly"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-bt-center">
                            ...
                            <button class="btn btn-gray" type="button" id="closeBtn">
                                <i class="ace-icon fa fa-check bigger-110 icon-gray"></i>
                                关 闭
                            </button>
                        </div>
                    </div>
