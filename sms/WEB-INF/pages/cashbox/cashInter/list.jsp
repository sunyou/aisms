...
<head>
    ...
    <script type="text/javascript" src="${ctx}/sms/statics/pages/js/cashbox/cashInter/list.js"></script>
...
<div class="wrap100 quickrecharge">
    ...
    <div class="q_r_list">
        ...
        <div class="listTable">
            <form id="searchForm" action="#">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <th class="r">调出钱箱号 ：</th>
                        <td><input id="searchCashBoxNo" class="inputW170" name="searchCashBoxNo"/>
                        </td>
                        <th class="r">申请单状态：</th>
                    ...
                    <th colspan="3" class="r n_b_b">
                        <a href="javascript:void(0)" onclick="openEdit()" id="fbox_grid-table_search"
                           class="fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset btn btn-sm btn-primary"><span
                                class="icon-credit-card"></span>调 出</a>
        ...
        <!--交易记录查询列表 begin-->
        <div>
            <table id="cashInter" width="100%" border="0" cellspacing="0" cellpadding="0">

            </table>
            <div id="cashInter_pager"></div>
        </div>
        <!--交易记录查询列表 end-->
    </div>
</div>
