...
<head>
    ...
    <script type="text/javascript" src="${ctx}/sms/statics/pages/js/singleitemaccount/singleitemDetail.js"></script>
...
<div class="main-content">    
        ...
        <div class="row">            
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">                
                    <div class="form-group">                        
                        ...
                        <div class="col-xs-3">                         
                            <input name="studyAccnumber" id="studyAccnumber" class="inputW120"  value="CJ201416670001"/>  
                        </div>
                        <label class="col-sm-3 control-label no-padding-right"> 住院次数： </label>
                        <div class="col-xs-3">                         
                            <input name="studyAccnumber" id="studyAccnumber" class="inputW120"  value="2"/>  
                        </div>
                        <label class="col-sm-3 control-label no-padding-right"> 住院原因： </label>
                        <div class="col-xs-3">                         
                            <input name="studyAccnumber" id="studyAccnumber" class="inputW120"  value="病伤"/>  
                        </div>
                     </div>
                     <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right"> 入院诊断： </label>
                        <div class="col-xs-3">                         
                            <input name="studyAccnumber" id="studyAccnumber" class="inputW120"  value="***疾病"/>  
                        </div> 
                        <label class="col-sm-3 control-label no-padding-right"> 出院诊断： </label>
                        <div class="col-xs-3">                         
                            <input name="studyAccnumber" id="studyAccnumber" class="inputW120"  value="***疾病"/>  
                        </div> 
                        <label class="col-sm-3 control-label no-padding-right"> 入院时间： </label>
                        <div class="col-xs-3">                         
                            <input name="studyAccnumber" id="studyAccnumber" class="inputW120"  value="2014-5-21"/>  
                        </div>                   
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right"> 出院时间： </label>
                        <div class="col-xs-3">                         
                            <input name="studyAccnumber" id="studyAccnumber" class="inputW120"  value="2014-6-17"/>  
                        </div> 
                        <label class="col-sm-3 control-label no-padding-right"> 住院天数： </label>
                        <div class="col-xs-3">                         
                            <input name="studyAccnumber" id="studyAccnumber" class="inputW120"  value="27"/>  
                        </div> 
                    </div>                                                         
			</div>	
		</div>	
	...
	<div class="page-content min_style" style="padding:0px 0px 0px;">
        <div class="row">            
            <h1>&nbsp;&nbsp;&nbsp;用药信息</h1>
			<div>
	           	<table id="userYaolist" width="100%" border="0" cellspacing="0" cellpadding="0">
	              
	           	</table>
	           	<div id="userYaolist_pager"></div>
	       	</div>
	...
	<div class="page-content min_style" style="padding:0px 0px 0px;">
        <div class="row">            
            <h1>&nbsp;&nbsp;&nbsp;检验检查信息</h1>
			<div>
	           	<table id="jianyanlist" width="100%" border="0" cellspacing="0" cellpadding="0">
	              
	           	</table>
	           	<div id="jianyanlist_pager"></div>
	       	</div>
	...
	<div class="page-content min_style" style="padding:0px 0px 0px;">
        <div class="row">            
            <h1>&nbsp;&nbsp;&nbsp;手术信息</h1>
			<div>
	           	<table id="shoushulist" width="100%" border="0" cellspacing="0" cellpadding="0">
	              
	           	</table>
	           	<div id="shoushulist_pager"></div>
	       	</div>
	...
	<div class="page-content min_style" style="padding:0px 0px 0px;">
        <div class="row">            
            <h1>&nbsp;&nbsp;&nbsp;费用信息</h1>
			<div>
	           	<table id="feiyonglist" width="100%" border="0" cellspacing="0" cellpadding="0">
	              
	           	</table>
	           	<div id="feiyonglist_pager"></div>
	       	</div>
              ...
              <table id="configTab" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                 <tr>
		            ...
		            <th width="10%" class="c">费用类别</th>            
		            <th width="15%" class="c">费用占比</th>
		          </tr>
		          <tr tag="studyItem">
		            <td width="10%" align = "center"> 
		               1  	                
