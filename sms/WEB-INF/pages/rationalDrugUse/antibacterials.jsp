	                    ...
	                    <tr>
	                        ...
	                        <td width="13%"  >
	                            <select id="ruleId" name="ruleId" style="width:160px;" >
	                                <option >请选择</option>
	                                <option value="2">规则1</option>
	                                <option value="3">规则2</option>
	                                <option value="4">规则3</option> 
	                            </select> 
	                        </td> 
	            ...
	            <form id="searchForm2" action="#">
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    ...
	                    <tr>                        
	                       ...
	                       <a href="javascript:void(0)" onclick="reloadGridHispital()" class="fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset btn btn-sm btn-success"><span class="icon-search"></span>查询</a> 
	                         
	                       <a href="javascript:void(0)" onclick="reset2()" class="fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search btn btn-sm btn-gray"><span class="icon-retweet"></span>重 置</a>
