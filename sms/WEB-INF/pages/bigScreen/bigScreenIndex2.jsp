...
<div class="wrap100 bigscreen">
    <div class="title">
        <h1>基于GIS的阳光医药监管信息平台<span >当前时间：<span id="time">2015-7-22 16:42:33</span></span></h1>
    </div>
    <div class="listTable">
...
<div class="wrap100 content">
    <div class="fl menu">
        <ul>
            <li><a href="${ctx}/bigScreen/index.html" >合理用药监管统计</a> </li>
            <li><a href="#"  class="current">大处方筛查统计</a> </li>
...
<script src="${ctx}/sms/statics/pages/js/bigscreen/bigScreenIndex2.js"></script>
