...
<head>
    ...
    <link href="${ctx}/sms/statics/pages/css/index/css/login.css" rel="stylesheet" type="text/css"/>
...
<div class="wrap100 loginTopBg">
    <div class="wrap"><img src="${ctx}/sms/statics/pages/css/index/images/food_logo.png"></div>
</div>
<!--top end-->

<!--loginContent begin-->
<div class="wrap loginContent">
    <div class="fl leftAdver"><img src="${ctx}/sms/statics/pages/css/index/images/leftAdver1.jpg"/></div>
    <!--login begin-->
        ...
        <div class="fl loginList" id="normal">
            ...
            <ul>
                ...
                <li>
                    ...
                    <img id="imageCheckCode" src="${ctx}/sms/common/checkCode/code?page=login_user"/>
                </li>
            </ul>
