...
<head>
    ...
    <script type="text/javascript" src="${ctx}/sms/statics/pages/js/recharge/Recharge.js"></script>
...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <div class="q_r_list">
        ...
        <!--充值 begin-->
        <h2><span class="active"><i class="r_i_marking">&nbsp;</i>充值</span></h2>
    	<div class="listTable">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <th class="r">充值类型：</th>
            <td><label id="rechargeType"></label></td>
            <th class="r">充值金额：</th>
            <td><input id="rechargeAmount" class="inputW150" />
            元</td>
            <td colspan="2">
                ...
                <a href="javascript:void(0)" onclick="ConfirmRecharge()" id="fbox_grid-table_cancel"
                   class="fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset btn btn-sm btn-success"><span
                        class="icon-check bigger-130"></span>充 值</a>
            </td>
          </tr>
        </table>
    </div>
...
<div class="quickrecharge" id="divConfirm" closed="true">

    <div class="q_r_list">

        <!--充值信息 begin-->
        <h2><span class="active"><i class="r_i_marking">&nbsp;</i>充值信息</span></h2>
    	<div class="listTable">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th width="13%" class="r">卡号：</th>
            ...
            <td width="22%"><strong><label id="name2"></label></strong></td>
          </tr>
          <tr>
            <th class="r">卡类型：</th>
          ...
          <tr>
            <th class="r"><strong>*</strong>充值金额：</th>
            <td><label id="rechargeAmount2"></label></td>
            <th class="r">充值类型：</th>
          ...
          <tr>
            <th colspan="4" class="c">
                <button onclick="Recharge();" class="btn btn-primary" type="button">
