...
<head>
    ...
    <script type="text/javascript" src="${ctx}/sms/statics/pages/js/sys/rolelist.js"></script>
...
<div class="wrap100 quickrecharge"> 
	...
	<!--查询条件 begin-->
        <div class="listTable">
            <form id="searchForm" action="#">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <th class="r" width="8%">角色名称 ：</th>
                        <td width="15%" colspan="2">
                            <input id="roleName" name="roleName" class="inputW120" />
                        </td>      
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                   <th class="r n_b_b" style="text-align:left;">
                        ...
                        <a href="javascript:void(0)" onclick="view(0,'roleStaff')" id="fbox_grid-table_search"
                           class="fm-button ui-state-default ui-corner-all fm-button-icon-left ui-reset btn btn-sm btn-primary"><span
                                class="icon-user"></span>角色用户菜单授权</a>
                    </th>
                </tr>
            </table>
        </div>
        <!--查询条件 end-->
			<div>
            	<table id="rolelist" width="100%" border="0" cellspacing="0" cellpadding="0">
