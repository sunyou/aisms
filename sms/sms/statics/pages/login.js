...
//    }
    ...
    var url =  GLOBAL.WEBROOT+"/sms/statics/common/images/loading.gif";
...
function verifyCode(tab){
    ...
    $.ajax({
        type: "POST",
        async: false,
        url:GLOBAL.WEBROOT +  '/sms/common/checkCode/validate.ajax',
...
function loginBack() {
    ...
    switch (errorCode) {
        ...
        case "0" :
        {
            window.top.location = "/sms/test/test.html";  //测试
            break;
...
function showDate(){
      ...
      var t="今天是"+mydate.getFullYear()+"年"+mydate.getMonth()+"月"+mydate.getDate()+"日 星期"+Week[mydate.getDay()];;
      $("#time").text(t);
