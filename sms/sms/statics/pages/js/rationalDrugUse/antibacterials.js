...
function reloadGridHispital(){
	...
	$("#anlistHispital").jqGrid('setGridParam', {postData: data,page:1,pageSize:8}).trigger("reloadGrid");
}
...
function reset(){
	...
	$("#searchForm").find("#month").val("");
	$("#searchForm").find("#dateTime").val("");
	$("#searchForm").find("#area").val("请选择"); 
	$("#searchForm").find("#level").val("请选择");
	$("#searchForm").find("#hospitalId").val("请选择");
	$("#searchForm").find("#ruleId").val("请选择");
	
}
 
function reset2(){
	$("#searchForm2").find("#year").val("");
	$("#searchForm2").find("#month").val("");
	$("#searchForm2").find("#dateTime").val("");
	$("#searchForm2").find("#area").val("请选择"); 
	$("#searchForm2").find("#level").val("请选择");
	$("#searchForm2").find("#hospitalId").val("请选择");
	$("#searchForm2").find("#ruleId").val("请选择");
	$("#searchForm2").find("#dateTime").val("");
