...
//        }
    ...
    function ztreeComp(inputSelector,multi,option,callFunc){
        ...
        var t = $("<div id=\""+divId+"\"  style=\"display:none; position: absolute;z-index:9999;\"><ul id=\""+treeId+"\" class=\"ztree\" style=\"margin-top:0; width:"+(obj.innerWidth()+2)+"px; height: 300px;\"></ul></div>");
        $('body').after(t);
        var settingForMulti = {
